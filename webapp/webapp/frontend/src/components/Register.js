...
const [ConPass,setPass]=useState({
  password:""
    ...
    <Form style={styleForm} onSubmit={handlesubmit} >
      ...
      <Form.Group className="mb-3" controlId="formBasicacademiclevel" style={styleLabel}>
        <Form.Label></Form.Label><br/>
        <Form.Control type="text" name="academiclevel" placeholder='Academic level' required value={data.academiclevel}  onChange={handlechange} style={styleinput} />
      </Form.Group>
