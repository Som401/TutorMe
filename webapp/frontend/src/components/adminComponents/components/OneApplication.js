    ...
    return (
      <>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            <p  style={{ fontSize: "20px",marginLeft: "20px" }}>{student.Name}</p>
            </div>
            <div style={{ flex: 1 }}>
              <p  style={{ fontSize: "20px",marginLeft: "20px" }}>{subject.SubjectName}</p>
            </div>
            <div style={{ flex: 1 }}>
            <p style={{ fontSize: "20px",marginLeft: "20px" }}>{elt.SubjectGrade}</p>
            </div>
