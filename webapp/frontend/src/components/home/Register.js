          ...
          <div>
            <div>
              <Form.Group
                ...
                style={styleLabel}
              >
                <Form.Label>{errors.Name}</Form.Label>
                <br />
                <Form.Control
                  type="text"
                  name="Name"
            ...
            <div>
              <Form.Group
                ...
                style={styleLabel}
              >
                <Form.Label>{errors.Email}</Form.Label>
                <br />
                <Form.Control
                  type="email"
                  name="Email"
            ...
            <div>
              ...
              <Form.Group
                ...
                style={styleLabel}
              >
                <Form.Label style={styleLabel}>{errors.Password}</Form.Label>
                <br />
                <Form.Control
                  type="password"
                  name="Password"
            ...
            <div>
              <Form.Group
                ...
                style={styleLabel}
              >
                <Form.Label style={styleLabel}>{errors.confirmPassword}</Form.Label>
                <br />
                <Form.Control
                  type="password"
                  name="password"
